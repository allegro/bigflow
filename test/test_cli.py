...
class CliTestCase(TestCase):
    ...
    def test_raise_error_when_given_file_is_not_tar(self):
        # given
    ...
    def test_raise_error_when_given_file_name_has_wrong_pattern(self):
        # given
    ...
    def test_raise_error_when_given_file_does_not_exists(self):
        with self.assertRaises(ValueError):
            # when
